...
class ActionController {
    ...
    private function _render($file) {
        ...
        $body .= $view->render(FrontController::$dirname
                . '/views/' . $file . '.phtml', $this->_response->getVars());
